...
const Home = () => {
  return (
    ...
    <div className="container">
      ...
      <div className="custom-shape-divider-bottom-1693225745">
        <svg
          data-name="Layer 1"
  ...
  <div id="carouselExample" className="carousel slide">
    <div className="carousel-inner">
      <div className="carousel-item active">
        <img src="./img/re1.jpg" className="d-block w-100" alt="..." />
      </div>
      <div className="carousel-item">
        <img src="/img/re2.jpg" className="d-block w-100" alt="..." />
      </div>
      <div className="carousel-item">
        <img src="/img/re3.jpg" className="d-block w-100" alt="..." />
      </div>
      <div className="carousel-item">
        <img src="/img/re4.jpg" className="d-block w-100" alt="..." />
      </div>
      <div className="carousel-item">
        <img src="/img/re1.png" className="d-block w-100" alt="..." />
      </div>
    </div>
